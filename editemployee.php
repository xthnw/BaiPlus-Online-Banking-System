...
if ($param3 != 'Administrator') {
    echo "<script>alert('You don\'t have access or permission to this page!'); window.location.href = 'employee.php';</script>";
    exit();
}
...
if (isset($_POST['update'])) {
    ...
    $sql = $conn->prepare("UPDATE `employee` SET employee_id = :id, 
                ...
                <div class="page-transition-slide-in-right">
                    <div class="modal-body">
                        ...
                        <form action="editemployee.php" method="POST" enctype="multipart/form-data">
                            ...
                            if (isset($_GET['id'])) {
                                $id = $_GET['id'];
                                $stmt = $conn->query("SELECT * FROM employee WHERE employee_id = '$id'");
                                $stmt->execute();
                                $data = $stmt->fetch();
                            }
                            ?>
                            <div class="form-group">
                                ...
                                <input type="text" readonly value="<?php echo $data['employee_id']; ?>" class="form-control" name="id" required>
                            </div>

                            <div class="form-row">
                                <div class="form-group col">
                                    <label>Employee First Name</label>
                                    <input type="text" value="<?php echo $data['employee_fname']; ?>" class="form-control" name="employee_fname">
                                </div>
                                <div class="form-group col">
                                    <label>Employee Last Name</label>
                                    <input type="text" value="<?php echo $data['employee_lname']; ?>" class="form-control" name="employee_lname">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <input type="text" value="<?php echo $data['employee_username']; ?>" class="form-control" name="employee_username" readonly>
                                </div>
                                <div class="form-group col">
                                    <label>Employee Password</label>
                                    <input type="password" value="<?php echo $data['employee_password']; ?>" class="form-control" name="employee_password" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="employee_role" class="form-control">
                                    <?php if ($data['employee_role'] === "Administrator") : ?>
                                        <option value="Administrator" selected>Administrator</option>
                                    <?php else : ?>
                                        <option value="Administrator">Administrator</option>
                                    <?php endif; ?>

                                    <?php if ($data['employee_role'] === "Manager") : ?>
                    ...
                    <div class="modal-footer">
                        <a href="employee.php" type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</a>
