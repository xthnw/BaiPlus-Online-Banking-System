...
if ($param3 != 'Administrator' & $param3 != 'Manager') {
    echo "<script>alert('You don\'t have access or permission to this page!'); window.location.href = 'index.php';</script>";
    exit();
}
...
$query = "SELECT a.account_type, COUNT(*) as num_blocked_accounts
...
$result_blocked_accounts = mysqli_query($conn, $query);
...
while ($row = mysqli_fetch_assoc($result_blocked_accounts)) {
    ...
    // Store the account type in the account_types array if it doesn't exist
    if (!in_array($account_type, $account_types)) {
        $account_types[] = $account_type;
    }

    // Store the data in the data_blocked_accounts array using the account type as the key
    $data_blocked_accounts[$account_type] = $num_blocked_accounts;
}
                            ...
                            <div class="col-xl-6 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div>
                                            <?php
                                            echo '<table class="table-responsive dataTable" id="dataTable1">';
                                            echo '<thead>';
                                            echo '<tr><th>Bank Name</th><th>Withdrawal</th><th>Transfer</th><th>Bill Payment</th><th>Loan Installment Payment</th></tr>';
                                            echo '</thead>';
                                            echo '<tbody>';
                                            foreach ($data as $bank_name => $trans_type) {
                                                echo '<tr>';
                                                echo '<td>' . $bank_name . '</td>';
                                                echo '<td>' . (isset($trans_type['Withdrawal']) ? $trans_type['Withdrawal'] : 0) . '</td>';
                                                echo '<td>' . (isset($trans_type['Transfer']) ? $trans_type['Transfer'] : 0) . '</td>';
                                                echo '<td>' . (isset($trans_type['Bill Payment']) ? $trans_type['Bill Payment'] : 0) . '</td>';
                                                echo '<td>' . (isset($trans_type['Loan Installment Payment']) ? $trans_type['Loan Installment Payment'] : 0) . '</td>';
                                                echo '</tr>';
                                            }
                                            echo '</tbody>';
                                            echo '</table>';
                                    ...
                                    <div class="card-body">
                                        <div>
                                            ...
                                            foreach ($account_types as $account_type) {
                                                ...
                                                echo '<td>' . (isset($data_blocked_accounts[$account_type]) ? $data_blocked_accounts[$account_type] : 0) . '</td>';
                                                echo '</tr>';
                                            }
                                            echo '</tbody>';
                                            echo '</table>';
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div>
                                            ...
                                            echo '<table class="table-responsive dataTable" id="dataTable1">';
                                            echo '<thead>';
                                            echo '<tr><th>Customer ID</th><th>Customer Name</th><th>Outstanding Debt</th></tr>';
                                            echo '</thead>';
                                            echo '<tbody>';
                                            foreach ($data_debt as $data) {
                                                echo '<tr>';
                                                echo '<td>' . $data['customer_id'] . '</td>';
                                                echo '<td>' . $data['customer_fname'] . '</td>';
                                                echo '<td>' . $data['outstanding_debt'] . '</td>';
                                                echo '</tr>';
                                            }
                                            echo '</tbody>';
                                            echo '</table>';
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div>
                                            ...
                                            echo '<table class="table-responsive dataTable" id="dataTable1">';
                                            echo '<thead>';
                                            echo '<tr><th>Biller Name</th><th>Total Bills Paid</th></tr>';
                                            echo '</thead>';
                                            echo '<tbody>';
                                            while ($row = mysqli_fetch_assoc($result_best_bill)) {
                                                echo '<tr>';
                                                echo '<td>' . $row['biller_name'] . '</td>';
                                                echo '<td>' . $row['total_bills_paid'] . '</td>';
                                                echo '</tr>';
                                            }
                                            echo '</tbody>';
                                            echo '</table>';
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div>
                                            ...
                                            echo '<table class="table-responsive dataTable" id="dataTable1">';
                                            echo '<thead>';
                                            echo '<tr><th>Age Range</th><th>Total Loans</th><th>On-time Payments</th><th>Total Loan Amount</th><th>Total Payments Amount</th><th>Percentage (Paid)</th></tr>';
                                            echo '</thead>';
                                            echo '<tbody>';
