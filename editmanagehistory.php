...
if ($param3 != 'Administrator') {
    echo "<script>alert('You don\'t have access or permission to this page!'); window.location.href = 'managehistory.php';</script>";
    exit();
}
...
if (isset($_POST['update'])) {
    ...
    $sql = $conn->prepare("UPDATE `managehistory` SET `datetime` = :id, 
    ...
    if ($sql) {
        ...
        header("location: managehistory.php");
    } else {
...
<head>
    ...
    <title>Manage History Table</title>
        ...
        overflow: hidden;
                ...
                <div class="page-transition-slide-in-right">
                    <div class="modal-body">
                        ...
                        <form action="editmanagehistory.php" method="POST" enctype="multipart/form-data">
                            <!-- <div class="modal-body">    ลดช่องบรรทัด enter -->

                            <?php
                            if (isset($_GET['id'])) {
                                $id = $_GET['id'];
                                $stmt = $conn->query("SELECT * FROM managehistory WHERE `datetime` = '$id'");
                                $stmt->execute();
                                $data = $stmt->fetch();
                            }
                            ?>
                            <div class="form-group">
                                ...
                                <input type="datetime-local" readonly value="<?php echo $data['datetime']; ?>" class="form-control" name="id" required>
                            </div>

                            <div class="form-row">
                                <div class="form-group col">
                                    <label>Employee ID</label>
                                    <input type="text" value="<?php echo $data['employee_id']; ?>" class="form-control" name="employee_id" readonly>
                                </div>
                                <div class="form-group col">
                                    <label>Account ID</label>
                                    <input type="text" value="<?php echo $data['account_id']; ?>" class="form-control" name="account_id" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <input type="text" value="<?php echo $data['action_type']; ?>" class="form-control" name="action_type" readonly>
                                </div>
                                <div class="form-group col">
                                    <label>Customer ID</label>
                                    <input type="text" value="<?php echo $data['customer_ID']; ?>" class="form-control" name="customer_ID" readonly>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col">
                                    <label>Card No</label>
                                    <input type="text" value="<?php echo $data['card_no']; ?>" class="form-control" name="card_no" readonly>
                                </div>
                                <div class="form-group col">
                                    <label>Loan ID</label>
                                    <input type="text" value="<?php echo $data['loan_id']; ?>" class="form-control" name="loan_id" readonly>
                                </div>
                            </div>
                    </div>
                    <div class="modal-footer">
                        <a href="managehistory.php" type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</a>
