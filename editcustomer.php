...
if (isset($_POST['update'])) {
    ...
    if (isset($_FILES['img']) && $_FILES['img']['error'] == 0) {
        ...
        $datetimeObj = new DateTime($customer_DOB);
        ...
        $img = $_FILES['img'];
        $salary_file2 = $_POST['salary_file2'];
        ...
        if ($upload != '') {
            ...
            $fileNew = $salary_file2;
        }



        $sql = $conn->prepare("UPDATE `customer` SET customer_ID = :id, 
...
<body id="page-top">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="editcustomer.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $data['customer_ID']; ?>" class="form-control" name="id" required readonly>
                                <input type="hidden" value="<?php echo $data['img']; ?>" class="form-control" name="img2">
                                <input type="hidden" value="<?php echo $data['salary_file']; ?>" class="form-control" name="salary_file2">
                            </div>

                            <div class="form-row">
                                <div class="form-group col">
                                    <label>First Name</label>
                                    <input input type="text" value="<?php echo $data['customer_fname']; ?>" class="form-control" name="customer_fname">
                                </div>
                                <div class="form-group col">
                                    <label>Last Name</label>
                                    <input type="text" name="customer_lname" class="form-control" value="<?php echo $data['customer_lname']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label> Email </label>
                                <input type="text" name="customer_email" class="form-control" value="<?php echo $data['customer_email']; ?>">
                            </div>

                            <div class="form-row">
                                <div class="form-group col">
                                    <label> Date of Birth </label>
                                    <input type="date" name="customer_DOB" class="form-control" value="<?php echo $data['customer_DOB']; ?>">
                                </div>
                                <div class="form-group col">
                                    <label> Gender </label>
                                    <select name="customer_gender" class="form-control">
                                        <?php if ($data['customer_gender'] === "") : ?>
                                            <option value="" selected></option>
                                        <?php else : ?>
                                            <option value=""></option>
                                        <?php endif; ?>

                                        <?php if ($data['customer_gender'] === "Male") : ?>
                                            <option value="Male" selected>Male</option>
                                        <?php else : ?>
                                            <option value="Male">Male</option>
                                        <?php endif; ?>

                                        <?php if ($data['customer_gender'] === "Female") : ?>
                                            <option value="Female" selected>Female</option>
                                        <?php else : ?>
                                            <option value="Female">Female</option>
                                        <?php endif; ?>

                                        <?php if ($data['customer_gender'] === "Other") : ?>
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    <label> Address </label>
                                    <input type="text" name="customer_address" class="form-control" value="<?php echo $data['customer_address']; ?>">
                                </div>
                                <div class="form-group col">
                                    ...
                                    <select name="customer_postcode" class="form-control">
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            $selected = ($customer_postcode == $data['customer_postcode']) ? "selected" : "";
                                            echo "<option value='$customer_postcode' $selected>$customer_postcode - $customer_city</option>";
                                        }
                                        mysqli_close($conn);
                                        ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="card_code" class="form-control" value="<?php echo $data['card_code']; ?>" pattern="[A-Z]{2}\d{10}" required title="Please enter a valid card code in the format JT1234567890." maxlength="12" minlength="12">
                            </div>
                            <div class="form-row">
                                <div class="form-group col">
                                    <label> Phone </label>
                                    <input type="text" name="customer_phone" class="form-control" value="<?php echo $data['customer_phone']; ?>" minlength="10" maxlength="10" pattern="\d+" title="Please enter 10 number">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <input type="password" name="customer_password" class="form-control" value="<?php echo $data['customer_password']; ?>" minlength="6" title="Please enter at least 6 characters" readonly>
                                    <br>
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="password" name="account_pin" class="form-control" value="<?php echo $data['account_pin']; ?>" minlength="6" maxlength="6" pattern="\d+" title="Please enter 6 numbers" readonly><br>
                                    <button type="button" class="btn btn-outline-warning" onclick="resetPin()">Reset PIN</button>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    <label> Salary </label>
                                    <input type="double" name="salary" class="form-control" value="<?php echo $data['salary']; ?>">
                                </div>
                                <div class="form-group col">
                                    <label> Salary File ( .JPG .JPEG .PNG .PDF)</label>
                                    <input type="file" name="img" id="imginput" class="form-control" value="<?php echo $data['salary_file']; ?>">
                                    <img width="50%" id="imgpreview" src="img/<?= $data['salary_file'] ?>" class="">

                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col" width="25px">
                                    <!-- <label> Image File ( .JPG .JPEG .PNG)</label> -->
                                    <!-- <input type="file" name="img" class="form-control" id="imginput" onchange="previewImage(event)"> -->
                                    <img width="100%" id="imgpreview" src="img/<?= $data['img'] ?>" class="circle">
                                </div>
                                <div type="" class="form-group col" width="25px">
                                    <label type="hidden"> </label>
                                    <input type="hidden" name="img" class="form-control" id="imginput" onchange="previewImage(event)">
                                    <img type="hidden" width="100%" id="imgpreview">
                                </div>
                            </div>
                    </div>
                    <div class="modal-footer">
                        <a href="customer.php" type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</a>
    ...
    <script>
        const maxLimitInput = document.querySelector('input[name="salary"]');
        ...
        maxLimitInput.addEventListener('input', function() {
            ...
            if (!regex.test(currentValue)) {
                const fixedValue = parseFloat(currentValue).toFixed(2); // round the value to 2 decimal places
                this.value = fixedValue; // update the input field value
                alert("Please enter a valid number with up to 2 decimal places."); // show an error message
            }
        });
    </script>
    ...
    <script>
        function resetPassword() {
            var customerID = '<?php echo $data['customer_ID']; ?>';
            var customerDOB = '<?php echo str_replace('-', '', $data['customer_DOB']); ?>';
            var newPassword = customerID + customerDOB;

            alert("Password will be change after that you press 'Save Data' button");

            // Replace the password input field value with the new password
    ...
    <script>
        function resetPin() {
            var newPin = '000000';
            alert("Pin will be change after that you press 'Save Data' button");
            var pinInput = document.querySelector('input[name="account_pin"]');
