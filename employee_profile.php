...
$paramcheck = NULL;
$paramcheck = $_SESSION['param1'];

if ($_SESSION['param1'] == NULL) {
...
$param6 = $_SESSION['param6']; // employeeID
...
if (isset($_POST['update'])) {
    ...
    $sql = $conn->prepare("UPDATE `employee` SET employee_password = :employee_password, 
        ...
        overflow: hidden;
                ...
                <div class="page-transition-slide-in-right">
                    <div class="modal-body">
                        ...
                        <form action="employee_profile.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="text" value="<?php echo $param1; ?>" class="form-control" name="employee_username" required readonly>
                                </div>
                                <div class="form-group col">
                                    <label for="id"> Password </label>
                                    <input type="password" value="<?php echo $param2; ?>" class="form-control" name="employee_password">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col">
                                    <label for="id"> First Name </label>
                                    <input type="text" value="<?php echo $param4; ?>" class="form-control" name="employee_fname" required>
                                </div>
                                <div class="form-group col">
                                    <label for="id"> Last Name </label>
                                    <input type="text" value="<?php echo $param5; ?>" class="form-control" name="employee_lname">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <select name="employee_role" class="form-control">
                                        <option value="<?php echo $param3; ?>" selected><?php echo $param3; ?></option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <a href="<?php echo $previousPage; ?>" type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</a>
